...
class ImageTestClass(TestCase):
    def setUp(self):
        ...
        self.image_cake = Image(image_name='image_cake', image_description='this is a test instance',
                                   image_location=self.image_location, image_category=self.image_category)
        self.image_cake.save_image()

        self.image_human = Image(image_name='image_human', image_description='this is a test instance',
                                 image_location=self.image_location, image_category=self.image_category)
        self.image_human.save_image()

    def test_instance(self):
        self.assertTrue(isinstance(self.image_cake, Image))
    ...
    def test_delete_image(self):
        self.image_cake.save_image()
        self.image_cake.delete_image()
        self.image_human.delete_image()
        images = Image.objects.all()
        self.assertTrue(len(images) == 0)